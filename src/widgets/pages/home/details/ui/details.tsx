  ...
  return (
    <div {...props} className={`${styles.wrapper} content-wrapper`}>
      <div className="grid grid-cols-4 grid-rows-3 gap-9 h-[80vh] w-full">
        <div className="col-span-2 row-span-2 flex items-center justify-center text-3xl font-bold relative rounded-[32px] overflow-hidden">
          <div
            ref={containerRef}
            style={{
              position: 'absolute',
        ...
        <div className="col-span-2 col-start-1 row-start-3 flex items-center justify-center text-3xl font-bold">
          <div className="border border-black w-full h-full rounded-[32px] overflow-hidden">
        ...
        <div className="col-start-3 row-start-1 flex items-center justify-center text-3xl font-bold rounded-[32px] overflow-hidden">
        ...
        <div className="row-span-2 col-start-3 row-start-2 flex items-center justify-center text-3xl font-bold rounded-[32px] overflow-hidden border border-black">
        ...
        <div className="row-span-2 col-start-4 row-start-1 flex items-center justify-center text-3xl font-bold rounded-[32px] overflow-hidden ">
        ...
        <div className="col-start-4 row-start-3 flex items-center justify-center text-3xl font-bold overflow-hidden border border-black rounded-[32px]">
