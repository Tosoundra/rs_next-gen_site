...
export const ServicesMock: Service[] = [
  ...
  },
  {
    ...
    slug: 'web-design',
    image: '/img/services/2.svg',
  },
  {
    title: 'Support',
    description:
      'We know that support is important!Every client is our friend, and friends are not abandoned in trouble. We know that nothing is impossible. Your problem is our solution. We will remove any headache for the product so that you can enjoy the result, excluding worries; We take care of them. Reliability and safety is the slogan of our support!',
    slug: 'Support',
    image: '/img/services/3.svg',
  },
  {
    title: 'Hosting',
